...
class familyFragmentAdapter(var context: Context): PagerAdapter() {

    var images: Array<Int> = arrayOf(R.drawable.ravi_bhai, R.drawable.rashmi_di, R.drawable.images_2, R.drawable.family,R.drawable.images_doli,R.drawable.sangeet)
